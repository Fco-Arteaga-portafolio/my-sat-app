...
export class RutaArchivoService {
    ...
    private resolverSlot(
        ...
        switch (id) {
            ...
            case 'ejercicio': return isNaN(fecha.getTime()) ? 'SIN_FECHA' : String(fecha.getFullYear())
            case 'periodo': return isNaN(fecha.getTime()) ? '00' : String(fecha.getMonth() + 1).padStart(2, '0')
